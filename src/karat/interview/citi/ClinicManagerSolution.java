...
//
//		public Appointment( int appointmentId, int doctorId, int patientId, int durationMinutes,
...
//
//		public AppointmentStats( int totalAppointments, int completedAppointments, double
//		noShowRate )
//			{
//
...
//			}
//
//		public AppointmentStats getAppointmentStatistics( int doctorId )
//			{
//
//				AppointmentStats stats = new AppointmentStats(0, 0, 0.0);
//
...
//								AppointmentType type = appt.type;
//							}
//
//
//						//		AppointmentStats stats = new AppointmentStats(appointments.sta)
//					}
//				AppointmentStats stats = new AppointmentStats(completedAppointments, totalAppointments,
//						noShowRate);
//
//				return stats;
//			}
...
//								totalDurationByType.put(type,
//										totalDurationByType.getOrDefault(type, 0) + appt.durationMinutes);
//							}
//					}
...
//	}
//
//public class ClinicManagerSolution
//	{
//
...
//						AppointmentType.FOLLOWUP));
//				AppointmentStats stats = cm.getAppointmentStatistics(10);
...
//				cm.addAppointment(new Appointment(1, 1, 100, 30, AppointmentStatus.COMPLETED,
//						AppointmentType.CONSULTATION));
//				cm.addAppointment(new Appointment(2, 1, 101, 41, AppointmentStatus.COMPLETED,
//						AppointmentType.CONSULTATION));
//				cm.addAppointment(new Appointment(3, 1, 102, 20, AppointmentStatus.COMPLETED,
//						AppointmentType.FOLLOWUP));
//				// not COMPLETED -> excluded from averages
//				cm.addAppointment(new Appointment(5, 1, 105, 100, AppointmentStatus.CANCELLED,
//						AppointmentType.CONSULTATION));
//				cm.addAppointment(new Appointment(4, 2, 103, 40, AppointmentStatus.COMPLETED,
//						AppointmentType.EMERGENCY));
//
//				int id = 1;
...
//					}
//
//				assert Math.abs(35.5 - avg1.get(AppointmentType.CONSULTATION)) < 1e-4 : "Expected 35.5" +
//						" for CONSULTATION";  // (30+41)/2
//				assert Math.abs(20.0 - avg1.get(AppointmentType.FOLLOWUP)) < 1e-4 : "Expected 20.0 for" +
//						" FOLLOWUP";
//				assert !avg1.containsKey(AppointmentType.EMERGENCY) : "EMERGENCY should not be in " +
//						"avg1";
//
//				System.out.println();
//
...
//				assert Math.abs(40.0 - avg2.get(AppointmentType.EMERGENCY)) < 1e-4 : "Expected 40.0 " +
//						"for EMERGENCY";
//				assert !avg2.containsKey(AppointmentType.CONSULTATION) : "CONSULTATION should not be " +
//						"in avg2";
...
//				assert cm.getAverageAppointmentDurationByType(3).isEmpty() : "Expected empty map for " +
//						"doctor with no appointments";
//				// unknown doctorId -> empty map
//				assert cm.getAverageAppointmentDurationByType(999).isEmpty() : "Expected empty map for" +
//						" unknown doctorId";
//			}
//	}